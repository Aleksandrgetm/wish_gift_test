...
const links = [
    ...
    { title: 'Suvenīri ar QR video', to: '/souvenirs' },
...
<template>
    <v-app>
        <div class="announcement">Personalizētas dāvanas ar foto, video, mūziku un QR kodu — pirms pasūtījuma noformēšanas saskaņojiet detaļas</div>
        ...
        <footer class="site-footer">
            <div class="shell footer-grid">
                <div><div class="footer-brand">wish_gift</div><p>Dāvanas, kas atdzīvojas: foto, video, mūzika un QR kods personalizētā suvenīrā.</p><v-btn color="secondary" size="small" href="mailto:ozivajka@inbox.lv">Izveidot savu dāvanu</v-btn></div>
                <div><h2>Navigācija</h2><router-link to="/catalog">Katalogs</router-link><router-link to="/souvenirs">Suvenīri ar QR video</router-link><router-link to="/contacts">Kontakti</router-link></div>
                <div><h2>Kontakti</h2><a href="tel:+37128153310">+371 28153310</a><a href="mailto:ozivajka@inbox.lv">ozivajka@inbox.lv</a><p>Vispirms saskaņojiet foto, video un mūziku ar menedžeri.</p></div>
            </div>
