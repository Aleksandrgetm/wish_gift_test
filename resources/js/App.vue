    ...
    <v-app>
        ...
        <footer class="site-footer">
            <div class="shell footer-grid">
                <div><div class="footer-brand">wish_gift</div><p>Подарки, которые оживают: фото, видео, музыка и QR-код в персональном сувенире.</p><v-btn color="secondary" size="small" href="mailto:ozivajka@inbox.lv">Создать свой подарок</v-btn></div>
